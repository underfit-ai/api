...
from app.permissions import require_account_admin
from app.repositories import collaborators as collaborators_repo
from app.repositories import users as users_repo
from app.routes.resolvers import resolve_account_and_project
...
def add_collaborator(
    ...
    collaborators_repo.add(conn, project.id, target.id)
    return {"id": str(target.id), "projectId": str(project.id), "userId": str(target.id)}
